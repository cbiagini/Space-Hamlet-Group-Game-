...
public class DialogueManagerForOnMouseDown : MonoBehaviour
{
    ...
    */
    ...
    public ShowDialogueOnMouseDown currentDialogue;
    ...
    private void Awake()
    {
        ...
        ShowDialogueOnMouseDown[] dialogueTriggerArray = FindObjectsOfType<ShowDialogueOnMouseDown>();
        ...
        foreach (ShowDialogueOnMouseDown dialogueTrigger in dialogueTriggerArray)
        {
    ...
    */
    public void ShowDialogue(ShowDialogueOnMouseDown newDialogue)
    {
    ...
    */
    public void HideDialogue(ShowDialogueOnMouseDown instigator)
    {
